...
/**
 * ref: https://docs.oracle.com/javase/specs/jvms/se17/html/jvms-4.html#jvms-4.7 - critical -
 * ConstantValue, Code, StackMapTable, BootstrapMethods, NestHost, NestMembers, PermittedSubclasses
 * - not critical, but used by libs - Exceptions, InnerClasses, EnclosingMethod, Synthetic,
 * Signature, Record, SourceFile, LineNumberTable, LocalVariableTable, LocalVariableTypeTable -
 * optional - SourceDebugExtension, Deprecated, RuntimeVisibleAnnotations,
 ...
 * RuntimeInvisibleTypeAnnotations, AnnotationDefault, MethodParameters, Module, ModulePackages,
 * ModuleMainClass
 */
public enum AttrName {
  ...
  private static Map<String, AttrName> entryMap =
      Arrays.stream(AttrName.values())

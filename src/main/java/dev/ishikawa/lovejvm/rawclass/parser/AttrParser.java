...
public class AttrParser {
    ...
    private static Attr parse(ConstantUtf8 attrName, int dataLength, int pointer, byte[] bytecode, ConstantPool constantPool) {
        ...
        switch (attrNameEnum) {
            ...
            case CODE: {
                ...
                return AttrCode.of(attrName, dataLength, operandStackSize, localsSize, instructionLength, instructionSection, exceptionHandlers, attrs);
            }
...
//                break;
            ...
            case LINE_NUMBER_TABLE: {
                ...
                for (int i = 0; i < entrySize; i++) {
                    ...
                    pointer += 2;
                    entries.add(new AttrLineNumberTable.LAttrLineNumberTableEntry(instructionLine, originalLine));
                }

...
public class BinaryNameParser {
  ...
  //  ↑                                         ↑
  private static Pair<String, Integer> readComplexClassBinaryName(char[] chars, int startPos) {
    int j = 1;
    while (true) {
  ...
  public static class Result {
    ...
    @Nullable private final String complexTypeBinaryName;
    @Nullable private final JvmType primaryType;

    public Result(
        boolean isArray, @Nullable String complexTypeBinaryName, @Nullable JvmType primaryType) {

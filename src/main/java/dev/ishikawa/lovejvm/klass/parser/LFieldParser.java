...
public class LFieldParser {
    public static Pair<Integer, LField> parse(int pointer, byte[] bytecode, ConstantPool constantPool) {
        ...
        return Pair.of(pointer, new LField(accessFlag, name, desc, attrs));
    }

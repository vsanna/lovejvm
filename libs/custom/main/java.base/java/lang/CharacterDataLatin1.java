...
class CharacterDataLatin1 extends CharacterData {
  ...
  static final int A[] = {
    ...
    0x68000018, //  38   Po, ON
    0x68000018, //  39   Po, ON
    -0x17FFFFEB, //  40   No, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    -0x17FFFFEA, //  41   Nl, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    0x68000018, //  42   Po, ON
    0x20000019, //  43   Sm, ES
    0x38000018, //  44   Po, CS
    ...
    0x38000018, //  46   Po, CS
    0x38000018, //  47   Po, CS
    -0xE7FFC9F7, //  48   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  49   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  50   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  51   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  52   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  53   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  54   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  55   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  56   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    -0xE7FFC9F7, //  57   Pc, WS, hasUpper (subtract 511), hasLower (add 511), hasTitle, whitespace,
    // strange
    0x38000018, //  58   Po, CS
    0x68000018, //  59   Po, ON
    -0x17FFFFE7, //  60   Me, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    0x68000019, //  61   Sm, ON
    -0x17FFFFE7, //  62   Me, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    0x68000018, //  63   Po, ON
    0x68000018, //  64   Po, ON
    ...
    -0x17FFFFEB, //  91   No, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    0x68000018, //  92   Po, ON
    -0x17FFFFEA, //  93   Nl, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    0x6800001B, //  94   Sk, ON
    ...
    -0x17FFFFEB, // 123   No, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    0x68000019, // 124   Sm, ON
    -0x17FFFFEA, // 125   Nl, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    ...
    -0x17FFFFE3, // 171   Lt, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    ...
    -0x97FFFFE8, // 183   Mc, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31
    ...
    -0x17FFFFE2, // 187   Ll, hasUpper (subtract 511), hasLower (add 511), hasTitle, identifier
    // start, supradecimal 31

...
class CharacterData00 extends CharacterData {
  ...
  boolean isUnicodeIdentifierStart(int ch) {
    return (getPropertiesEx(ch) & 0x0040) != 0 || ch == 0x2E2F;
  }

  boolean isUnicodeIdentifierPart(int ch) {
    return (getPropertiesEx(ch) & 0x0080) != 0 || isIdentifierIgnorable(ch) || ch == 0x2E2F;
  }
    ...
    switch (val & 0xC00) {
      ...
      case (0x00000800): // "strange" numeric
        switch (ch) {
          ...
          case 0x324B:
            retval = 40;
            break; // CIRCLED NUMBER FORTY ON BLACK SQUARE
          case 0x324C:
            retval = 50;
            break; // CIRCLED NUMBER FIFTY ON BLACK SQUARE
          case 0x324D:
            retval = 60;
            break; // CIRCLED NUMBER SIXTY ON BLACK SQUARE
          case 0x324E:
            retval = 70;
            break; // CIRCLED NUMBER SEVENTY ON BLACK SQUARE
          case 0x324F:
            retval = 80;
            break; // CIRCLED NUMBER EIGHTY ON BLACK SQUARE
          case 0x325C:
            retval = 32;
            break; // CIRCLED NUMBER THIRTY TWO
          case 0x325D:
            retval = 33;
